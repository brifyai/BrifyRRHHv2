...
-- Este script crea las tablas necesarias para el sistema de comunicación
...
-- Crear tabla de relación empleado-habilidades
...
-- Crear tabla de relación empleado-intereses
...
-- Crear tabla de registros de comunicación
CREATE TABLE IF NOT EXISTS communication_logs (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  sender_id UUID REFERENCES employees(id),
  recipient_ids UUID[], -- Array de IDs de empleados destinatarios
