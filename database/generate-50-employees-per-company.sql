...
-- Este script asegura que cada empresa tenga exactamente 50 empleados con datos realistas

-- Primero, verificar cuántos empleados hay por empresa actualmente
SELECT 
  c.name AS company,
