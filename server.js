...
const microsoft365Handler = require('./src/api/webhook/microsoft365-notifications.js');
const zoomHandler = require('./src/api/webhook/zoom-notifications.js');
const googleCalendarHandler = require('./src/api/webhook/google-calendar-notifications.js');
const googleMeetExtensionsHandler = require('./src/api/webhook/google-meet-extensions.js');
const googleMeetRealtimeHandler = require('./src/api/webhook/google-meet-realtime.js');
const driveNotificationsHandler = require('./src/api/webhook/drive-notifications.js');
