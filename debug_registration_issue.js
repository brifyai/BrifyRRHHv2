...
const supabaseServiceKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InRtcWdsbnljaXZsY2ppam95bXdlIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc2MDU1NDU0NiwiZXhwIjoyMDc2MTMwNTQ2fQ.pBfkSsN_x5-t9y2GlOVKKbG8GjvlHNfKjvvXNPZvyUo'
...
async function debugRegistration() {
  ...
  if (rlsError) {
    console.log('⚠️  No se pueden verificar políticas RLS (puede ser normal)')
  } else {
    console.log('✅ Políticas RLS:', rlsPolicies)
  }
  ...
  // 4. Verificar si el usuario existe después de la creación
  console.log('\n4. Verificando si el usuario existe:')
