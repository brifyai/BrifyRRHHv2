                ...
                <div className="lg:col-span-2">
                  <div className="mb-4">
                    ...
                    <textarea
                      ...
                      className="shadow-sm focus:ring-engage-blue focus:border-engage-blue block w-full sm:text-sm border-gray-300 rounded-md"
                  ...
                  <div className="flex space-x-3">
                    ...
                    >
                      <PaperAirplaneIcon className="h-5 w-5 mr-2" />
                      {isSending ? 'Enviando...' : 'Enviar por Telegram'}
                    </button>
                  </div>
                </div>
                
                <div className="bg-gray-50 rounded-lg p-4">
                  <h3 className="text-sm font-medium text-gray-900 mb-3">Empleados seleccionados</h3>
                  <div className="max-h-60 overflow-y-auto">
                    {selectedEmployees.length === 0 ? (
                      <p className="text-sm text-gray-500">No hay empleados seleccionados</p>
                    ) : (
                      <ul className="space-y-2">
                        {filteredEmployees
                          .filter(emp => selectedEmployees.includes(emp.id))
                          .map(employee => (
                            <li key={employee.id} className="flex items-center text-sm">
                              <div className="flex-shrink-0 h-8 w-8 bg-engage-blue/10 rounded-full flex items-center justify-center mr-2">
                              ...
                              <div>
                                ...
                                <div className="text-gray-500">{employee.company}</div>
                              </div>
                            </li>
                          ))}
                      </ul>
        ...
        {activeTab === 'templates' && (
          <div className="space-y-6">
            <div className="flex justify-between items-center">
              <h2 className="text-lg font-semibold text-engage-black">Plantillas de Mensajes</h2>
              <button
                onClick={() => setShowTemplateModal(true)}
                className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-engage-blue hover:bg-engage-yellow focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-engage-blue"
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {templates.map(template => (
                <div key={template.id} className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                  <div className="flex justify-between items-start mb-3">
                    <h3 className="text-lg font-semibold text-engage-black">{template.name}</h3>
                    <div className="flex space-x-2">
                      <button className="text-gray-400 hover:text-engage-blue">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-xs text-gray-500">Modificado: {template.lastModified}</span>
              ...
              {templates.length === 0 && (
                <div className="col-span-full text-center py-12">
                  ...
                  <p className="mt-1 text-sm text-gray-500">
                    Comienza creando tu primera plantilla de